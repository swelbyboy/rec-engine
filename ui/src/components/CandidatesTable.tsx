      ...
      <table className="w-full text-xs">
        <thead>
          <tr style={{ background: "rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
            {["Name", "Discipline", "Experience", "Seniority", "Skills", "Industries"].map((h) => (
          ...
          {candidates.map((c, i) => (
            ...
            >
              ...
              <td className="px-3 py-2.5 whitespace-nowrap">
                <span className="inline-flex rounded px-1.5 py-0.5" style={{ background: "rgba(213,250,84,0.1)", color: "#d5fa54" }}>
                  {c.discipline}
                </span>
              </td>
